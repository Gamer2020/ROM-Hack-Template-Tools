...
Module mMain
    ...
    Public Sub LoadImage()
        ...
        Using fs As New FileStream(MnFrm.TextBox1.Text, FileMode.Open, FileAccess.Read)
            Using r As New BinaryReader(fs)
                fs.Position = sOffset
                r.Read(Temp, 0, &HFFFF)

                If MnFrm.CheckBox1.Checked = True Then
        ...
        Using fs As New FileStream(MnFrm.TextBox2.Text, FileMode.Open, FileAccess.Read)
            Using r As New BinaryReader(fs)
        ...
        '        ConvertBitmapToPalette(bSprite, Palette32, True)
