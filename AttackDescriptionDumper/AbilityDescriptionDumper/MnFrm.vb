    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If fileOpenDialog.ShowDialog = DialogResult.OK Then
            ...
            While (loopvar < (GetString(GetINIFileLocation(), header, "NumberOfAttacks", ""))) = True
                ...
                Dim AbilityDesc As Integer = Int32.Parse((GetString(GetINIFileLocation(), header, "AttackDescriptionTable", "")), System.Globalization.NumberStyles.HexNumber)

                Dim descPointer As String = Hex(Int32.Parse((ReverseHEX(ReadHEX(LoadedROM, (AbilityDesc) + ((loopvar - 1) * 4), 4))), System.Globalization.NumberStyles.HexNumber) - &H8000000)
                ...
                pointertext = pointertext & ".word " & GetAttackName(loopvar).Replace(" ", "_") & "_description" & vbCrLf

                descriptext = descriptext & "" & GetAttackName(loopvar).Replace(" ", "_") & "_description:" & vbCrLf & ".byte " & ((EveryN(DescpText, 1, "_, ").Replace(" _", "Space")).Replace(".", "Dot, ")).Replace("+_", "JumpLine") & "Termin" & vbCrLf & vbCrLf
