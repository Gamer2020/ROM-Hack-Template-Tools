...
Public Class MnFrm
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Tiles1 = LoadTilesTopBitmap(TextBox1.Text, TilePals(ComboBox1.SelectedIndex), CheckBox1.Checked)
        Tiles2 = LoadTilesTopBitmap(TextBox4.Text, TilePals(ComboBox1.SelectedIndex), CheckBox1.Checked)

        TilesPictureBox.Image = Tiles1
